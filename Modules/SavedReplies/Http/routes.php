...
Route::group(['middleware' => 'web', 'namespace' => 'Modules\SavedReplies\Http\Controllers'], function()
{
    Route::get('/mailbox/saved-replies/{id}', 'SavedRepliesController@index')->name('mailboxes.saved_replies');
    Route::get('/mailbox/saved-replies/ajax-html/{action}', ['uses' => 'SavedRepliesController@ajaxHtml', 'laroute' => true])->name('mailboxes.saved_replies.ajax_html');

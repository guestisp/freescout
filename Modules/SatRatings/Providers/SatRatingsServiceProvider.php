...
<a href="{%ratings.great%}" style="color:#50bc1c;">Great</a> &nbsp;&nbsp; <a href="{%ratings.okay%}" style="color:#555555;">Okay</a> &nbsp;&nbsp; <a href="{%ratings.bad%}" style="color:#f10000;">Not Good</a><br>';
    ...
    public static $default_trans = [
        'title'           => 'Satisfaction Ratings',
        'prompt'          => 'How would you rate the support you received?',
        'level_great'     => 'Great',
        'level_okay'      => 'Okay',
        'level_bad'       => 'Not Good',
        'comment'         => 'Would you like to share any other comments?',
        'submit'          => 'Send',
        'success_title'   => 'Thanks for your rating!',
    ...
    {
        $langPath = resource_path('lang/modules/satratings');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'satratings');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'satratings');
        }
    }

        ...
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal margin-top margin-bottom-40" method="POST" action="" id="form-trans">
                    ...
                    <div class="subheading">{{ __('Landing Page') }}</div>
                    ...
                    <div class="form-group{{ $errors->has('trans.prompt') ? ' has-error' : '' }}">
                        <label for="trans_prompt" class="col-sm-2 control-label">{{ __('Prompt') }}</label>

                        <div class="col-sm-6">
                            <textarea id="trans_prompt" class="form-control input-sized" name="trans[prompt]" rows="2" required="required" autofocus="autofocus" data-default="{{ $default['prompt'] }}">{{ old('trans.prompt', $trans['prompt'])  }}</textarea>
                            <div class="{{ $errors->has('trans.prompt') ? ' has-error' : '' }}">
                                @include('partials/field_error', ['field'=>'trans.prompt'])
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="subheading margin-top-30">{{ __('Thank You Page') }}</div>

                    <div class="form-group{{ $errors->has('trans.success_title') ? ' has-error' : '' }}">
                        <label for="trans_success_title" class="col-sm-2 control-label">{{ __('Page Title') }}</label>
                    ...
                    <div class="form-group{{ $errors->has('trans.success_message') ? ' has-error' : '' }}">
                        <label for="trans_success_message" class="col-sm-2 control-label">{{ __('Thank You Message') }}</label>

...
Route::group(['middleware' => 'web', 'namespace' => 'Modules\SatRatings\Http\Controllers'], function()
{
    ...
    Route::post('/mailbox/satisfaction-ratings/{id}', ['uses' => 'SatRatingsController@settingsSave', 'middleware' => ['auth', 'roles'], 'roles' => ['admin']])->name('mailboxes.sat_ratings');
